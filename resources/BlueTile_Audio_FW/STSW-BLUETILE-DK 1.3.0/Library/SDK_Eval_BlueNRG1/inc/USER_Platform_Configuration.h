...
extern "C" {
	 ...
	 */
#define PUSH_BUTTON1_PIN                 GPIO_Pin_11
#define PUSH_BUTTON2_PIN                 GPIO_Pin_12
...
#ifdef BLUENRG_TILE
/**
 * @brief BlueNRG1 Eval Board (STEVAL-BCN002V1) LEDs definitions
 */

#define SDK_EVAL_LED1_PIN             GPIO_Pin_3 //LED RED
#define SDK_EVAL_LED2_PIN             GPIO_Pin_14  //LED Green
#define SDK_EVAL_LED3_PIN             GPIO_Pin_0  //LED Blue
...
#ifdef BLUENRG_TILE
#define SDK_EVAL_IRQ_SENSOR_PIN                   GPIO_Pin_13
#else
