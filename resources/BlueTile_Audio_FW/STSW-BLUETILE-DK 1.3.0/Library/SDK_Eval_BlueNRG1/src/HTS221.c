...
HTS221_Error_et HTS221_ReadReg( void *handle, uint8_t RegAddr, uint16_t NumByteToRead, uint8_t *Data )
{
  ...
  return HTS221_IO_Read(Data, HTS221_I2C_ADDRESS, RegAddr, NumByteToRead);
}
...
{
      return HTS221_IO_Write(Data, HTS221_I2C_ADDRESS, RegAddr, NumByteToWrite);
