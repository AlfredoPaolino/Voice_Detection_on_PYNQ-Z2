...
#define NUM_APP_GATT_SERVICES (3 + 1) /* 3 Sensor services + 1 OTA service */

/* Number of attributes requests from the chat demo */
#define NUM_APP_GATT_ATTRIBUTES (39 + 9) /* 39 attributes x BLE Sensor demo services characteristics + 9 for OTA Service characteristics */
...
#define NUM_APP_GATT_ATTRIBUTES 45
...
/* Maximum number of attribute records that can be added to the first application service 1 */
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_1 (34)

/* Maximum number of attribute records that can be added to the second application service 2 */
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_2 (4)

/* Maximum number of attribute records that can be added to the second application service 3 */
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_3 (7)
...
#define ATT_VALUE_ARRAY_SIZE    (820  + OTA_ATT_VALUE_ARRAY_SIZE)
#else
#define ATT_VALUE_ARRAY_SIZE    (467 + OTA_ATT_VALUE_ARRAY_SIZE)
#endif 
